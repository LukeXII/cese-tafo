...
extern void vTaskLed(void const * argument);
...
SemaphoreHandle_t mutexSemaphoreHandle;
...
int main(void)
{
  ...
  /* add semaphores, ... */
	...
	mutexSemaphoreHandle = xSemaphoreCreateMutex();
    /* Check the queues was created successfully */
	configASSERT( mutexSemaphoreHandle != NULL );
  ...
  osThreadDef(TaskLed, vTaskLed_, osPriorityNormal, 0, 1000);
  TaskLedHandle = osThreadCreate(osThread(TaskLed), NULL);

  /* definition and creation of TaskButton */
  osThreadDef(TaskButton, vTaskButton_, osPriorityNormal, 0, 1000);
...
/* USER CODE BEGIN Header_vTaskLed_ */
/**
  * @brief  Function implementing the TaskLed thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_vTaskLed_ */
void vTaskLed_(void const * argument)
{
  /* USER CODE BEGIN 5 */
	char *pcTaskName;
	...
	pcTaskName = ( char * ) pcTaskGetName( NULL );
...
/* USER CODE BEGIN Header_vTaskButton_ */
/**
* @brief Function implementing the TaskButton thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_vTaskButton_ */
void vTaskButton_(void const * argument)
{
  /* USER CODE BEGIN vTaskButton_ */
	char *pcTaskName;
